...
if (isset($_POST['reset-request-submit'])) {
  ...
  $url = "localhost/prec/forgottenpwd/create-new-password.php?selector=" . $selector . "&validator=" . bin2hex($token);
  ...
  // Headers
  // Headers
  $headers = "From: Stephen <st3phenflynn@gmail.com>\r\n";
  $headers .= "Reply-To: st3phenflynn@gmail.com\r\n";
